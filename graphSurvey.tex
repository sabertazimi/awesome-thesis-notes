...
\subsection{GraVF}
GraVF~\cite{DBLP:conf/fpl/EngelhardtS16}

\subsection{Energy Efficient Processing}
~\cite{DBLP:conf/fccm/ZhouCP16}

\subsection{FPGP}
FPGP~\cite{DBLP:conf/fpga/DaiCWY16} is a framework
...
HMC~\cite{DBLP:conf/fpga/ZhangKL17}
allows to select the size of the transferred data payload
...
~\cite{DBLP:conf/fpga/ZhangL18}~\cite{DBLP:conf/fpga/KhoramZSL18}

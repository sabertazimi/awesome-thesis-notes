...
Asynchronous has these characteristics~\cite{DBLP:journals/csur/McCuneWM15}:
\begin{compactitem}
  \item no explicit synchronization points, no straggler problem
  \item providing more execution flexibility
...
Large adjacency list partitioning (LALP) from GPS:
...
Both the forward and reverse edge trees are each stored in a chunk storage structure
that compresses data structure information

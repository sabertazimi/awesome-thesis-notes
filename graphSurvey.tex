...
PowerSwitch~\cite{DBLP:conf/ppopp/XieCGZC15}
removes the need to choose between synchronous and asynchronous execution
and instead \textbf{adaptively switches} between the two modes to improve performance.
